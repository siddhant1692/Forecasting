...
cocacolasales<-read_xlsx("D:\\Data Science\\Excelr\\Assignments\\Assignment\\Forecasting\\CocaCola_Sales_Rawdata.xlsx") 
View(cocacolasales)
# Converting data into time series object
sales<-ts(cocacolasales$Sales,frequency = 4,start=c(86))
View(sales)
plot(sales)
